<x-admin-layout activeRoute="dashboard" header="Ringkasan Dashboard">
    <div class="space-y-8 animate-fade-in" x-data="adminDashboardController()" x-init="initDashboard()">
        ...
        <div x-show="reports.is_using_default_password" class="p-4 rounded-2xl bg-red-500/10 border border-red-500/20 flex flex-col sm:flex-row items-center justify-between gap-4 text-red-850 dark:text-red-400" x-cloak>
            <div class="flex items-center gap-3">
                ...
                <div class="text-left">
                    ...
                    <p class="text-[10px] text-slate-600 font-medium dark:text-slate-300 mt-0.5">Anda masih menggunakan kata sandi bawaan seeder. Demi keamanan data wisata, silakan segera ubah kata sandi Anda.</p>
                </div>
            </div>
        ...
        <div class="grid grid-cols-1 sm:grid-cols-3 gap-6">
            <!-- Total Revenue Card -->
            <div class="bg-white dark:bg-slate-900 border border-emerald-100 dark:border-emerald-900/40 rounded-3xl p-6 flex items-center justify-between shadow-xl shadow-slate-200/60 dark:shadow-none hover:-translate-y-1.5 hover:shadow-2xl hover:shadow-emerald-900/10 hover:border-emerald-300 dark:hover:border-emerald-700 transition-all duration-300">
                <div class="space-y-1">
                    <p class="text-xs font-semibold text-slate-600 font-medium dark:text-slate-300 uppercase tracking-wider">Total Pendapatan</p>
            ...
            <div class="bg-white dark:bg-slate-900 border border-emerald-100 dark:border-emerald-900/40 rounded-3xl p-6 flex items-center justify-between shadow-xl shadow-slate-200/60 dark:shadow-none hover:-translate-y-1.5 hover:shadow-2xl hover:shadow-emerald-900/10 hover:border-emerald-300 dark:hover:border-emerald-700 transition-all duration-300">
                <div class="space-y-1">
                    <p class="text-xs font-semibold text-slate-600 font-medium dark:text-slate-300 uppercase tracking-wider">Tiket Terjual</p>
                    <h3 class="text-2xl font-black text-slate-800 dark:text-white"><span x-text="reports.tickets_sold">0</span> <span class="text-xs font-medium text-slate-600 font-medium dark:text-slate-300">orang</span></h3>
                </div>
            ...
            <div class="bg-white dark:bg-slate-900 border border-emerald-100 dark:border-emerald-900/40 rounded-3xl p-6 flex items-center justify-between shadow-xl shadow-slate-200/60 dark:shadow-none hover:-translate-y-1.5 hover:shadow-2xl hover:shadow-emerald-900/10 hover:border-emerald-300 dark:hover:border-emerald-700 transition-all duration-300">
                <div class="space-y-1">
                    <p class="text-xs font-semibold text-slate-600 font-medium dark:text-slate-300 uppercase tracking-wider">Wisatawan Unik</p>
                    <h3 class="text-2xl font-black text-slate-800 dark:text-white"><span x-text="reports.total_visitors">0</span> <span class="text-xs font-medium text-slate-600 font-medium dark:text-slate-300">akun</span></h3>
                </div>
        ...
        <div class="grid grid-cols-1 lg:grid-cols-3 gap-6">
            ...
            <div class="lg:col-span-2 bg-white dark:bg-slate-900 border border-emerald-100 dark:border-emerald-900/40 rounded-3xl p-6 sm:p-8 shadow-xl shadow-slate-200/60 dark:shadow-none hover:-translate-y-1.5 hover:shadow-2xl hover:shadow-emerald-900/10 hover:border-emerald-300 dark:hover:border-emerald-700 transition-all duration-300 space-y-6">
                <div class="flex items-center justify-between">
                    <div>
                        ...
                        <p class="text-xs text-slate-600 font-medium dark:text-slate-300">Total penjualan harian tiket wisata yang berhasil lunas.</p>
                    </div>
                    <!-- Indicator -->
                ...
                <div class="space-y-4">
                    <!-- Chart frame -->
                    <div class="h-64 bg-slate-50/50 dark:bg-slate-950/50 rounded-2xl p-4 border border-emerald-100 dark:border-emerald-900/30 flex items-end justify-between space-x-2 sm:space-x-4">
                        <template x-for="(day, idx) in reports.chart_data" :key="day.raw_date">
                            <div class="flex-1 flex flex-col items-center group relative h-full justify-end">
                                ...
                                <!-- Label (Date) -->
                                <span class="text-[10px] text-slate-600 font-medium dark:text-slate-300 mt-2 font-bold" x-text="day.label"></span>
                            </div>
                        </template>
                    </div>
                </div>
            ...
            <div class="bg-white dark:bg-slate-900 border border-emerald-100 dark:border-emerald-900/40 rounded-3xl p-6 sm:p-8 shadow-xl shadow-slate-200/60 dark:shadow-none hover:-translate-y-1.5 hover:shadow-2xl hover:shadow-emerald-900/10 hover:border-emerald-300 dark:hover:border-emerald-700 transition-all duration-300 space-y-6">
                <div>
                    ...
                    <p class="text-xs text-slate-600 font-medium dark:text-slate-300">Kuantitas penjualan lunas tertinggi.</p>
                </div>

                <div class="space-y-5">
                    <template x-if="reports.popular_tickets.length === 0">
                        <p class="text-xs text-slate-600 font-medium dark:text-slate-300 italic py-4">Belum ada transaksi tiket lunas.</p>
                    </template>
                    ...
                    <template x-for="(ticket, idx) in reports.popular_tickets" :key="idx">
                        <div class="space-y-2">
                            <div class="flex items-center justify-between text-xs font-semibold">
                                ...
                                <span class="text-slate-600 font-medium dark:text-slate-300" x-text="ticket.sold + ' Terjual'"></span>
                            </div>
        ...
        <div class="grid grid-cols-1 lg:grid-cols-3 gap-6">
            ...
            <div class="lg:col-span-2 bg-white dark:bg-slate-900 border border-emerald-100 dark:border-emerald-900/40 rounded-3xl p-6 sm:p-8 shadow-xl shadow-slate-200/60 dark:shadow-none hover:-translate-y-1.5 hover:shadow-2xl hover:shadow-emerald-900/10 hover:border-emerald-300 dark:hover:border-emerald-700 transition-all duration-300 space-y-6">
                <div class="flex items-center justify-between">
                    <div>
                        ...
                        <p class="text-xs text-slate-600 font-medium dark:text-slate-300">Daftar 5 aktivitas pembelian tiket terbaru.</p>
                    </div>
                ...
                <div class="overflow-x-auto">
                    <table class="w-full text-left text-xs border-collapse">
                        <thead>
                            <tr class="border-b border-emerald-100 dark:border-emerald-900/30 text-slate-600 font-medium dark:text-slate-300 font-bold uppercase tracking-wider">
                        ...
                        <tbody class="divide-y divide-slate-100 dark:divide-slate-800">
                            <template x-if="reports.recent_orders.length === 0">
                                <tr>
                                    <td colspan="6" class="py-6 text-center text-slate-600 font-medium dark:text-slate-300 italic">Belum ada transaksi pembelian.</td>
                                </tr>
                            </template>
            ...
            <div class="bg-white dark:bg-slate-900 border border-emerald-100 dark:border-emerald-900/40 rounded-3xl p-6 sm:p-8 shadow-xl shadow-slate-200/60 dark:shadow-none hover:-translate-y-1.5 hover:shadow-2xl hover:shadow-emerald-900/10 hover:border-emerald-300 dark:hover:border-emerald-700 transition-all duration-300 space-y-6">
                ...
                <div class="space-y-4">
                    <!-- Tickets Count & Link -->
                    <a href="{{ route('admin.tickets') }}" class="flex items-center justify-between p-3.5 border border-emerald-100 dark:border-emerald-900/30 rounded-2xl hover:border-emerald-500/20 bg-slate-50/50 dark:bg-slate-950/30 hover:bg-emerald-500/5 transition-all group">
                        <div class="flex items-center gap-3">
                            ...
                            <div>
                                ...
                                <p class="text-[10px] text-slate-600 font-medium dark:text-slate-300" x-text="stats.ticketsCount + ' Tiket terdaftar'"></p>
                            </div>
                        </div>
                        <span class="text-slate-600 font-medium dark:text-slate-300 group-hover:translate-x-1 transition-transform">&rarr;</span>
                    </a>

                    <!-- Facilities Count & Link -->
                    <a href="{{ route('admin.facilities') }}" class="flex items-center justify-between p-3.5 border border-emerald-100 dark:border-emerald-900/30 rounded-2xl hover:border-teal-500/20 bg-slate-50/50 dark:bg-slate-950/30 hover:bg-teal-500/5 transition-all group">
                        <div class="flex items-center gap-3">
                            ...
                            <div>
                                ...
                                <p class="text-[10px] text-slate-600 font-medium dark:text-slate-300" x-text="stats.facilitiesCount + ' Sarana terdaftar'"></p>
                            </div>
                        </div>
                        <span class="text-slate-600 font-medium dark:text-slate-300 group-hover:translate-x-1 transition-transform">&rarr;</span>
                    </a>
                    ...
                    <!-- Articles Count & Link -->
                    <a href="{{ route('admin.articles') }}" class="flex items-center justify-between p-3.5 border border-emerald-100 dark:border-emerald-900/30 rounded-2xl hover:border-sky-500/20 bg-slate-50/50 dark:bg-slate-950/30 hover:bg-sky-500/5 transition-all group">
                        <div class="flex items-center gap-3">
                            ...
                            <div>
                                ...
                                <p class="text-[10px] text-slate-600 font-medium dark:text-slate-300" x-text="stats.articlesCount + ' Artikel edukasi'"></p>
                            </div>
                        </div>
                        <span class="text-slate-600 font-medium dark:text-slate-300 group-hover:translate-x-1 transition-transform">&rarr;</span>
                    </a>
                    ...
                    <a href="{{ route('admin.settings') }}" class="flex items-center justify-between p-3.5 border border-emerald-100 dark:border-emerald-900/30 rounded-2xl hover:border-violet-500/20 bg-slate-50/50 dark:bg-slate-950/30 hover:bg-violet-500/5 transition-all group">
                        <div class="flex items-center gap-3">
                            ...
                            <div>
                                ...
                                <p class="text-[10px] text-slate-600 font-medium dark:text-slate-300">Operasional & Informasi Wisata</p>
                            </div>
                        </div>
                        <span class="text-slate-600 font-medium dark:text-slate-300 group-hover:translate-x-1 transition-transform">&rarr;</span>
                    </a>
