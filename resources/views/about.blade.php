        ...
        <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 space-y-20">
            ...
            <div class="grid grid-cols-1 lg:grid-cols-2 gap-12 items-start">
                <div class="space-y-6">
                    ...
                    <p class="text-slate-600 dark:text-slate-300 leading-relaxed text-sm sm:text-base whitespace-pre-line">
                ...
                <div class="bg-slate-50 dark:bg-slate-800 p-4 rounded-3xl border border-emerald-100 dark:border-emerald-900/30 shadow-xl shadow-slate-200/60 dark:shadow-none hover:-translate-y-1.5 hover:shadow-2xl hover:shadow-emerald-900/10 hover:border-emerald-300 dark:hover:border-emerald-700 transition-all duration-300">
            ...
            <div class="grid grid-cols-1 md:grid-cols-2 gap-8">
                <!-- Visi -->
                <div class="p-8 bg-slate-50 dark:bg-slate-800/40 rounded-3xl space-y-4 border border-emerald-100 dark:border-emerald-900/30">
            ...
            <div class="space-y-6 text-center max-w-4xl mx-auto pt-8 border-t border-emerald-100 dark:border-emerald-900/30">
                ...
                <p class="text-slate-600 font-medium dark:text-slate-300 text-sm max-w-lg mx-auto">Berikut adalah susunan komite dan kepengurusan pengelola Eduwisata Sawah Pulo Farm.</p>
                
                <div class="bg-slate-50 dark:bg-slate-800/40 p-4 rounded-3xl border border-emerald-100 dark:border-emerald-900/30 shadow-inner max-w-2xl mx-auto">
